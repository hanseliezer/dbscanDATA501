...
#' * Clustering quality: four internal validation metrics are provided and a description of what should
...
#' quality of clusters generated by density-based clustering, as they have an underlying assumption that
#' the generated clusters are approximately globular in shape, whereas density-based algorithms such as
