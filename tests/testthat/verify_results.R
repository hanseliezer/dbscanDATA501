...
dbscan_true_fpc <- fpc::dbscan(scale(classif), test_min_pts, test_eps)$cluster
dbscan_true_dbs <- dbscan::dbscan(scale(classif), test_min_pts, test_eps)$cluster
dbscan_my <- dbscan(classif, test_min_pts, test_eps)$cluster_labs
